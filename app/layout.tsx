 ...
 *
 * Only the two fonts every page uses live here. Newsreader sets the problem
 * brief and appears nowhere else, so it is declared in components/detail-view
 * instead — declaring it here made every route, including the landing page,
 * preload 58 KB that painted nothing.
 */
